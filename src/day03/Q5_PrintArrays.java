...
public class Q5_PrintArrays {
		
		/*Create a statsic method name:acceptString
		 * It should accept 3 strings as parameter and print them as an array
		 ...
		 * It should take accept 3 strings as parameter and print each element in  the array
		 * e.g. String[] array={"sam","john","tom"};
		 * acceptString("sam","john","tom");
		 * then output:sam john tom
