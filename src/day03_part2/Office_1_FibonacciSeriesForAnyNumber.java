...
public class Office_1_FibonacciSeriesForAnyNumber {
	...
	/*
	 * Write a method which accepts an integer as parameter and returns “true” if it
	 * is a Fibonacci number
	 *
	 * Then check the result and print “Fibonacci series contain your number” or
	 * “Fibonacci series contain that numbers : X and Y” (X and Y should be the
	 * closest Fibonacci numbers to given number X<num<Y)
	 */
