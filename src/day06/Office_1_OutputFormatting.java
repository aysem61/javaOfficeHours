...
public class Office_1_OutputFormatting {
	 ...
	 * Input Format
		...
		if the original input has less than three digits, you must pad
		...
		The leading digit of the integer is the 16th character, and
